...
class WorkerAgent:
    ...
    def execute_benchmark_job(self, job_info: Dict) -> Dict:
        ...
        try:
            ...
            # Get device info
            device_info = get_device_info()
            logger.info(f"[DEVICE] DeviceName={device_info.get('DeviceName')}, DeviceOs={device_info.get('DeviceOs')}, Soc={device_info.get('Soc')}, Ram={device_info.get('Ram')}")
            ...
            logger.info(f"[RESULT] DeviceName={result.get('DeviceName')}, Soc={result.get('Soc')}, Ram={result.get('Ram')}")
            ...
            # Get device info even on failure
            device_info = get_device_info()
