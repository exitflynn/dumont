...
echo "  cyclops-worker start --host <url>"
echo "  cyclops-worker enroll --host <url>"
...
echo -e "     ${CYAN}cyclops-worker enroll --host http://<ip>:5000${NC}"
echo ""
echo -e "  ${YELLOW}4. Start the worker:${NC}"
echo -e "     ${CYAN}cyclops-worker start --host http://<ip>:5000${NC}"
echo ""
